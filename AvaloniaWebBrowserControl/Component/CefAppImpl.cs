...
namespace AvaloniaWebBrowserControl.Component
{
    public class CefAppImpl : CefNetApplication
    {
        protected override void OnBeforeCommandLineProcessing(string processType, CefCommandLine commandLine)
        {
            ...
            //foreach (var item in Helper.AppEnvironment.EmbeddedBrowser.Settings)
            //    commandLine.AppendSwitchWithValue(item.Key, item.Value);
        }

        protected override void OnContextCreated(CefNet.CefBrowser browser, CefFrame frame, CefV8Context context)
        {
